...
public class QuantizedDeductCalculationStrategyTest {
	...
	private QuantizedDeductCalculationStrategy strategy = new QuantizedDeductCalculationStrategy();
	
	@Before
	public void setUp() {
		when(fixedPaymentCalculator.calculateFixedPayments(eq(period),
				eq(TaxCalculationSettings.defaults().splitByQuants(true))))
				.thenReturn(taxes);
	...
	public static List<Object[]> parameters() {
		return asList(new Object[][] {
			{pp(YEAR), asList(tx(100, I), tx(1000, I), tx(200, II), tx(20, II), tx(600, IV)), BigDecimal.valueOf(500), asList(td(1600, I), td(220, II), td(600, IV))},
			{pp(YEAR), asList(tx(100, I), tx(1000, I), tx(200, II), tx(20, II)), BigDecimal.ZERO, asList(td(1100, I), td(220, II))},
			{pp(YEAR), asList(tx(200, II), tx(20, II)), BigDecimal.valueOf(500), asList(td(500, I), td(220, II))},
			{pp(YEAR), asList(tx(200, II), tx(20, II)), BigDecimal.ZERO, asList(td(220, II))},
			{pp(YEAR), Collections.emptyList(), BigDecimal.ZERO, Collections.emptyList()},
			{pp(I), asList(tx(100, I), tx(1000, I), tx(200, II), tx(20, II), tx(600, IV)), BigDecimal.valueOf(500), Collections.emptyList()},
		});
	}
