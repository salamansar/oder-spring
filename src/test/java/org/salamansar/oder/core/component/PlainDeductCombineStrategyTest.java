 ...
 * @author Salamansar
 */
public class PlainDeductCombineStrategyTest {
	
	private PlainDeductCombineStrategy strategy = new PlainDeductCombineStrategy();
	...
	public void calculateDeductedPayment() {
		...
		assertTrue(BigDecimal.valueOf(899.85).compareTo(result) == 0);
	}
	...
	public void calculateDeductedWithEmptyDeduction() {
		...
		assertTrue(BigDecimal.valueOf(1000.35).compareTo(result) == 0);
	}
